...
#'
#' @param distri Character string specifying the distribution. Options are "poi" or "nb".
#' @param stan_fit A \code{stanfit} object returned by \code{get_stanfit}.
#' @return A summary of the parameter estimates, including HPD intervals.
#'
#' @examples
#' \dontrun{
...
get_est <- function(distri, stan_fit) {
  ...
  est_selected <- est_selected[, c("Mean", "SD", "Median", "Q2.5", "Q97.5", "Rhat")]
